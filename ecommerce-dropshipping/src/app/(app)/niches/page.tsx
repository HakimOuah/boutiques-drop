...
import { Tag, Plus, Upload, Search, Compass } from "lucide-react";
import { getNiches } from "@/lib/actions/niches";
...
export default async function NichesPage({
  ...
  const niches = await getNiches(searchParams.q);
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/agents#niche-discovery"
            className="flex items-center gap-2 rounded-lg border border-[#10b981]/30 bg-[#10b981]/10 px-4 py-2 text-sm text-[#10b981] hover:bg-[#10b981]/20 transition-colors"
          >
