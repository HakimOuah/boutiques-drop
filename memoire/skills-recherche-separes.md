...
1. **`ideation-produit`** — deux modes PRODUIT PUR / UNIVERS. TrendTrack seulement (Google Ads Search ou Shopping, shops, Meta = signal d'univers). Plus de Brand Search (19/08). Pré-filtre d'amont. Aucun volume, aucun AliExpress, aucun GO. Plancher **50–400 €**.
