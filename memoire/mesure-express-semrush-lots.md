...
**How to apply:** Le total « Volume total » du KMT est un plafond broad, jamais un adressable : lire le vocabulaire (marques d'enseignes, location, persona pro, licences) et estimer prudemment le cœur pertinent ; les familles distinctes ne s'additionnent jamais **en PRODUIT PUR**. En UNIVERS, on consolide les collections d'un même catalogue. Minage actuel : TrendTrack (`ideation-produit`), plus Brand Search. Voir [[deux-modes-produit-univers-trendtrack]] et [[boucle-chasse-clusters-volume-first]].
