...
**How to apply:** Le total « Volume total » du KMT est un plafond broad, jamais un adressable : lire le vocabulaire (marques d'enseignes, location, persona pro, licences) et estimer prudemment le cœur pertinent ; les familles distinctes ne s'additionnent jamais. Le preset UI de Hakim « shop google » (app.brandsearch.co) encode la recette de minage — équivalent MCP : `country_code FR`, `meta_active_max 0`, tri `google_ads_total` desc, prix ≥ 50 $ côté client. Voir [[brand-search-source-idees]] et [[boucle-chasse-clusters-volume-first]].
