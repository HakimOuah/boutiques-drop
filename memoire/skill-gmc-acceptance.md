...
- `.claude/skills/shopping-scaling/` — scaling Google Ads PMAX profit-first (4 phases, règle 2 jours verts +20–30 % / 2 jours rouges −20–30 %, AOV ≥ 60 $ avant de scaler ; enrichi 20/08/2026 : gate tracking achat-primary + écart Ads/Shopify, hygiène assets PMAX / message match, diagnostic causes externes avant scale down — distillat ciblé des agents Paid Media de msitarzewski/agency-agents, sans contredire Terry ni dupliquer les skills `ads`/`ad-creative`).
- `.claude/skills/webdesign-boutiques/` — DA + UI boutiques (ui-ux-pro-max + règles maison) ; enrichi 20/08/2026 : finish gate PASS/HOLD anti-UI générique + cohérence marque légère (inspiré UI Finish-Gate Reviewer agency-agents, adapté Shopify FR / DA créative).
