...
**Mise à jour 24/08/2026.** Recap opérationnel plié dans le skill. Pour les **nouvelles** boutiques : domaine 30+ j (acheter → monter → attendre quelques semaines, jamais d'expiré racheté) ; Gmail dédié **et** vivant (newsletters, YouTube, Search, 5–7 j de chauffe) ; un n° par boutique (on/off vocal OK, SIM physique > eSIM > VoIP) ; une adresse Maps par boutique, gardée après approbation ; policies **au nom de la marque** (jamais SIREN / TVA / SASU / OH Ventures) ; pack templates = PDFs éprouvés, chiffres identiques partout, délais AliExpress = 1–2 / 6–8 / 7–10 si c'est la réalité. Proxy : 1 IP **ISP** IPRoyal (statique, France) par profil Chrome Gmail/GMC/Ads — jamais Shopify derrière, jamais de residential tournant. Recette : `references/proxy-iproyal.md`. Parc déjà validé : on ne touche pas. Détail isolation : [[identite-partagee-gmc]].
