...
description: "Les 4 boutiques partagent adresse et téléphone ; Hakim assume le linkage GMC et soumet en séquence, Tuftéo seul d'abord"
metadata: 
  node_type: memory
  type: project
  originSessionId: 578c8896-7f46-48a6-ab64-d0045d9c4b9c
  modified: 2026-08-16T21:58:44.913Z
---

Vérifié le 16/08/2026 : **les quatre boutiques publient la même adresse et le même téléphone**. Bien Brûlé, Bonum Vitae, Tuftéo et Maison Noirmont affichent toutes `47 rue Vivienne, 75002 Paris` et le `+33 7 56 82 80 94` (avec des écritures variables). Ce n'est pas une négligence : c'est le **siège social de la SASU OH Ventures** (SIREN 103157251), que le droit français impose de publier dans les mentions légales.
