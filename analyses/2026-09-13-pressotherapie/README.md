# Pressothérapie — préqualification — 13/09/2026

Piste issue du catalogue SerenitaHome (bottes de compression vendues 249,90 €, trouvées à
70,39 € sur AliExpress avec +10 000 ventes) et déjà notée « à creuser » par Hakim le 05/09.

## 1. Demande — SEMrush France fourni par Hakim

Graines `pressothérapie` et `bottes de pressothérapie`. Seul le haut des listes est visible :
les chiffres sont des planchers.

### Mots-clés produit retenus

| Mot-clé | Volume | CPC |
|---|---:|---:|
| pressothérapie | **18 100** | 0,56 € |
| bottes pressothérapie | 5 400 | 0,60 € |
| bottes de pressothérapie | 4 400 | 0,50 € |
| botte pressothérapie | 3 600 | 0,60 € |
| pressothérapie bottes | 2 400 | 0,60 € |
| pressothérapie jambes | 2 400 | 0,56 € |
| pressothérapie des jambes | 1 300 | 0,56 € |
| pressothérapie jambe | 880 | 0,56 € |
| appareil de pressothérapie | 720 | 0,49 € |
| pressothérapie appareil · appareil pressothérapie | 590 · 390 | 0,55 € |
| appareil pressothérapie pour drainage lymphatique | 390 | 0,47 € |
| botte de pressothérapie | 390 | 0,50 € |
| machine pressothérapie | 320 | 0,48 € |
| bottes de pressothérapie pour drainage lymphatique | 170 | 0,47 € |
| meilleures bottes de pressothérapie | 140 | 0,80 € |

### Écartés

| Poste | Volume | Détail |
|---|---:|---|
| **Marques et enseignes** | **3 430** | Decathlon 1 600 + 720 + 70 · Lidl 390 + 50 · Fitem 260 + 90 · Zenova 90 + 70 · Jolt 90 |
| Informationnel | ≈ 6 800 | danger 880 · avant/après 720 + 590 + 320 + 260 · avis ≈ 2 000 · combien de fois par semaine 720 · bienfaits 910 · tarif 480 |
| Soin en cabinet et pharmacie | 1 170 | kiné 390 · kinésithérapie 390 · pharmacie 390 |

### Trois lectures du volume

| Lecture | Volume |
|---|---:|
| Brut des mots-clés produit retenus | **≈ 41 600** |
| Net, variantes d'ordre fusionnées (« bottes » et « bottes de » gardées séparées) | **≈ 33 900** |
| Net prudent, variantes avec « de / des » aussi fusionnées | **≈ 27 300** |

**Le verdict dépend presque entièrement de la tête `pressothérapie` (18 100).** Sans elle,
le produit pèse 9 000 à 16 000.

### La tête est à moitié un soin, pas un produit

SERP organique de `pressothérapie` — 9 résultats lus :

- **soin en cabinet** : elsan.care (clinique) · institut-kinesitherapie.paris ·
  dr-charlot-esthetique.com (médecin esthétique) · bodyaddiction.fr (institut)
- **vente de matériel** : prevarice.com · sissel.fr · compex.com · sport-orthese.com ·
  bastideleconfortmedical.com

Environ **la moitié** de la requête cherche une séance, pas un appareil. C'est la
polysémie service/produit déjà rencontrée sur `coiffeuse`, en moins sévère.

## 2. Ce qui est favorable — et c'est beaucoup

**Le marché paie** : CPC de 0,50 à 0,60 € sur toutes les têtes produit, difficulté SEO 16
à 24. Rien à voir avec le déambulateur (CPC 0,00 €).

**Google Shopping `bottes de pressothérapie` — bloc sponsorisé** :

| Marchand | Prix | Nature |
|---|---:|---|
| **Dreo Tech** | **199,97 €** | indépendant |
| **airlegz.com** | **249,00 €** | indépendant |
| **Pulsax** (AirPulse Pro) | **349,99 €** | indépendant |
| JOLT — jambières seules | 284,90 € | marque DTC (1 000+ avis) |
| JOLT — pack complet | 669,00 € | marque DTC |
| FITEM Recup PLUS | 899,95 € | marque DTC |
| AliExpress en direct | 238,69 · 360,39 € | fournisseur |

**Des indépendants à 200–350 €**, des marques DTC au-dessus, AliExpress en direct.
**Aucune grande surface dans le bloc payant** : Decathlon et Lidl n'apparaissent que dans
les requêtes de marque.

**Ticket 200 à 350 €** contre un coût fournisseur repéré à 70,39 € (niveau B, à confirmer) :
c'est le meilleur couple ticket/marge vu depuis le début de la chasse.

## 3. Réserves

1. **Allégations (§3).** « Drainage lymphatique », « jambes lourdes », « circulation » sont
   des promesses de santé, et le lymphœdème relève de la prescription. Les indépendants et
   les marques qui enchérissent se positionnent sur la **récupération** (JOLT, FITEM
   « Recup », AirLegz « récupération ») : c'est le même mouvement que le passage
   d'« orthopédique » à « pied large ». L'angle récupération/jambes légères est à mesurer.
2. **Produit électrique** (§6) : vigilance conformité et SAV.
3. **Mode.** C'est un **produit phare + accessoires** (bottes, manchons bras, ceinture,
   rechanges) plutôt qu'un univers de collections : lecture PRODUIT PUR plus pertinente que
   la somme UNIVERS.
4. **Sourcing non vérifié** : aucune fiche ouverte en niveau A.

## 4. Verdict

**`REVIEW_PREQUALIFICATION`.** Le volume encadre le seuil de 30 000 (27 300 à 33 900) et
repose sur une tête à moitié servicielle ; mais le marché paie, le Shopping est ouvert à des
indépendants à 200–350 €, et la marge est la meilleure de la chasse.
