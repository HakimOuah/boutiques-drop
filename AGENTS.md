...
- **Cinq repos**, chacun son périmètre — un tableau dans `CLAUDE.md` dit où va quoi. Exception cloud 11/09 (403 `boutique-pipeline`) : `CLAUDE.md` + [`docs/smp-portage-pipeline.md`](docs/smp-portage-pipeline.md).
